  ...
  const [diaryEntries, setDiaryEntries] = useState<DiaryEntryType[]>([
    {
      ...
      title: "새로운 시작",
      content:
        "오늘은 새로운 마음으로 상담을 시작했다. 처음엔 어색했지만 점점 마음이 편해지는 것 같다. 앞으로 더 솔직하게 이야기해보고 싶다.",
      emotion: "happy",
      imageUrl: "/placeholder.svg?height=200&width=300",
      summary: "새로운 상담 시작에 대한 긍정적인 마음",
    },
    {
      id: "2",
      ...
      title: "복잡한 하루",
      content:
        "직장에서 일이 많아서 스트레스를 많이 받았다. 동료들과의 관계도 조금 어려웠다. 하지만 상담을 통해 조금씩 정리가 되는 것 같다.",
      emotion: "anxious",
      imageUrl: "/placeholder.svg?height=200&width=300",
      summary: "직장 스트레스와 대인관계의 어려움",
    },
  ])
